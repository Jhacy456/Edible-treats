...
import { FaMapMarkerAlt, FaEnvelope, FaUserAlt, FaPhoneAlt, FaInstagram, FaTwitter, FaLinkedin } from 'react-icons/fa';

const ContactForm = () => {
    return (
        <div className="min-h-screen bg-[#FDF2F8] flex items-center justify-center px-4">
            {/* Form Container */}
            <div className="relative bg-white rounded-xl shadow-xl w-full max-w-3xl p-8 md:p-10 flex flex-col md:flex-row items-center">
                
                {/* Contact Card */}
                <div className="absolute -left-24 top-1/2 transform -translate-y-1/2 w-80 bg-[#ec4899] text-white shadow-lg p-6 z-10">
                ...
                {/* Form Section */}
                <div className="ml-auto w-full md:w-2/3 md:pl-10 z-0">
                    ...
                    <form className="space-y-4 w-[90%] max-w-[350px]">
                        <input
                            type="text"
