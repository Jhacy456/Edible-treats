          ...
          <div className="flex overflow-hidden">
            ...
            >
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="min-w-full flex justify-center px-4">
                  <div className="bg-white rounded-lg shadow-md p-6 sm:p-8 border-t-4 border-[#a855f7] w-full max-w-[90%] sm:max-w-md md:max-w-xl">
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-300 cursor-pointer ${
                activeSlide === index ? "bg-[#a855f7] w-6" : "bg-[#c797f5]"
              }`}
